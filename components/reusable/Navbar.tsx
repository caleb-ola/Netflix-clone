...
const Navbar = () => {
  ...
  width?.addEventListener("scroll", ChangeBg);
  ...
  return (
    <div className={`${navbg && "hero__nav--bg"}`}>
      <nav
        className={`navbar navbar-expand-lg bg-body-tertiary hero__nav py-2 position-fixed w-100  ${
          navbg && "hero__nav--bg"
        }`}
      >
        <div
